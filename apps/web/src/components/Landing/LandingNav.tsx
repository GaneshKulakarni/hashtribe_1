...
import { Menu, X, Bell, Search, User, Home, Trophy, Users, Compass, MessageSquare, Settings, LogOut } from 'lucide-react';
                        ...
                        <div className="absolute right-0 top-0 bottom-0 w-80 bg-charcoal-900 border-l border-charcoal-800 overflow-y-auto">
                            ...
                            <div className="p-6 border-b border-charcoal-800">
                                <div className="flex items-center justify-between mb-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-xl font-bold text-white">HashTribe</span>
                                    </div>
                                    <button
                                        onClick={() => setIsMenuOpen(false)}
                                ...
                                <div className="flex items-center gap-3 p-4 rounded-xl bg-white/5">
                                    <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary-500/20 to-purple-500/20 flex items-center justify-center">
                                        <User className="w-6 h-6 text-primary-400" />
                                    </div>
                                    <div>
                                        <div className="font-medium text-white">Guest User</div>
                                        <div className="text-sm text-grey-400">Sign in to continue</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="p-6 border-t border-charcoal-800">
                                <div className="space-y-4">
                                    <Link
                                        to="/signup"
                                        className="block w-full py-3 text-center font-bold text-white rounded-lg bg-gradient-to-r from-primary-500 to-primary-600 hover:from-primary-600 hover:to-primary-700 transition-all"
                                        onClick={() => setIsMenuOpen(false)}
                                    >
                                        Create Account
                                    </Link>
                                    <Link
                                        to="/login"
                                        className="block w-full py-3 text-center font-medium text-primary-400 hover:text-primary-300 transition-colors"
                                        onClick={() => setIsMenuOpen(false)}
                                    >
