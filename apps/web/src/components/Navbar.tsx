                            ...
                            <>
                                ...
                                <div className="flex items-center border-r border-grey-200 dark:border-charcoal-800 pr-3 space-x-1">
                                    ...
                                    <div className="relative">
                                        ...
                                        {unreadNotifCount > 0 && (
                                            <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] bg-red-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center px-1 border-2 border-white dark:border-black pointer-events-none">
